...
function Order() {
  ...
  const { cartItem, clearCart, darkMode } = useCart();
  ...
  return (
    ...
    >
      <div className="mx-auto max-w-7xl">
        <h2 className="tracking-wide text-3xl py-5 font-bold dark:text-indigo-500 text-gray-900">
          Thank you for your order
        </h2>
        <h4 className="text-2xl dark:text-white text-gray-900 pb-5">
        ...
        <div className="flex justify-between py-5">
          <h3 className="text-2xl font-bold dark:text-indigo-500 text-gray-900">
            Total
          </h3>
          <span className="text-2xl italic font-bold dark:text-white text-gray-900">
